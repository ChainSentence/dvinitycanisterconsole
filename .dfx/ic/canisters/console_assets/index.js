...
import { idlFactory } from './console_assets.did.js';
export { idlFactory } from './console_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CONSOLE_ASSETS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./console_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the console_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./console_assets.did.js")._SERVICE>}
 */
export const console_assets = createActor(canisterId);
